...
if __name__ == '__main__':
    ...
    if args.eval:
        ...
        eval_path = "/data/jykang/database/ASVspoof21/"
        eval_set=Dataset_ASVspoof2021_eval(list_IDs = file_eval,base_dir = os.path.join(eval_path+'ASVspoof2021_{}_eval/'.format(args.track)))
